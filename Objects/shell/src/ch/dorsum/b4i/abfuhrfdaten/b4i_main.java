...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("ch.dorsum.b4i.abfuhrfdaten.b4i_main");
        //anywheresoftware.b4a.pc.RapidSub.moduleToObject.put("ch.dorsum.b4i.abfuhrfdaten.b4i_main", "ch.dorsum.b4i.abfuhrfdaten.b4i_main");
	}
